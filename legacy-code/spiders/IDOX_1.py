...
from urls.portal_websites import IDOX_1

class IDOX1Spider(IdoxSpider):
    name = "IDOX_1"
    
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # Override the URL list with IDOX_1
        self.start_urls = IDOX_1
        # Update allowed domains based on the new URL list
        self.allowed_domains = [url.split('/')[2] for url in IDOX_1]
    
    def start_requests(self):
        """Generate initial requests for each council in IDOX_1"""
