...
from urls.portal_websites import IDOX_5

class IDOX5Spider(IdoxSpider):
    name = "IDOX_5"
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Override the URL list with IDOX_5
        self.start_urls = IDOX_5
        # Update allowed domains based on the new URL list
        self.allowed_domains = [url.split('/')[2] for url in IDOX_5]
    
    def start_requests(self):
        """Generate initial requests for each council in IDOX_5"""
