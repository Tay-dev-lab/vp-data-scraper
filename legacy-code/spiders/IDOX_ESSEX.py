...
from urls.portal_websites import IDOX_ESSEX

class IDOX_ESSEX_Spider(IdoxSpider):
    name = "IDOX_ESSEX"
    
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # Override the URL list with IDOX_10
        self.start_urls = IDOX_ESSEX
        # Update allowed domains based on the new URL list
        self.allowed_domains = [url.split('/')[2] for url in IDOX_ESSEX]
