...
from urls.portal_websites import IDOX_9

class IDOX9Spider(IdoxSpider):
    name = "IDOX_9"
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Override the URL list with IDOX_9
        self.start_urls = IDOX_9
        # Update allowed domains based on the new URL list
        self.allowed_domains = [url.split('/')[2] for url in IDOX_9]
    
    def start_requests(self):
        """Generate initial requests for each council in IDOX_9"""
