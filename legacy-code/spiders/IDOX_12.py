...
from urls.portal_websites import IDOX_12

class IDOX12Spider(IdoxSpider):
    name = "IDOX_12"
    
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # Override the URL list with IDOX_12
        self.start_urls = IDOX_12
        # Update allowed domains based on the new URL list
        self.allowed_domains = [url.split('/')[2] for url in IDOX_12]
    
    def start_requests(self):
        """Generate initial requests for each council in IDOX_12"""
