...
from urls.portal_websites import IDOX_6

class IDOX6Spider(IdoxSpider):
    name = "IDOX_6"
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Override the URL list with IDOX_6
        self.start_urls = IDOX_6
        # Update allowed domains based on the new URL list
        self.allowed_domains = [url.split('/')[2] for url in IDOX_6]
    
    def start_requests(self):
        """Generate initial requests for each council in IDOX_6"""
