...
from urls.portal_websites import IDOX_2

class IDOX2Spider(IdoxSpider):
    name = "IDOX_2"
    
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # Override the URL list with IDOX_2
        self.start_urls = IDOX_2
        # Update allowed domains based on the new URL list
        self.allowed_domains = [url.split('/')[2] for url in IDOX_2]
    
    def start_requests(self):
        """Generate initial requests for each council in IDOX_2"""
