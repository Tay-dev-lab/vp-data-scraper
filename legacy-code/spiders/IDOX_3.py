...
from urls.portal_websites import IDOX_3

class IDOX3Spider(IdoxSpider):
    name = "IDOX_3"
    
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # Override the URL list with IDOX_3
        self.start_urls = IDOX_3
        # Update allowed domains based on the new URL list
        self.allowed_domains = [url.split('/')[2] for url in IDOX_3]
    
    def start_requests(self):
        """Generate initial requests for each council in IDOX_3"""
